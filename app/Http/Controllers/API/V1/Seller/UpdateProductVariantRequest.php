...
class UpdateProductVariantRequest extends FormRequest
{
     ...
     * variants belonging to products owned by their
     * approved seller business.
     */
    public function authorize(): bool
    {
        ...
        /*
         * Seller catalog management is available only
         * to approved seller businesses.
         */
        ...
        /*
         * Never allow a seller to update a product
         * belonging to another seller profile.
         */
        if (
        ...
        /*
         * Never allow a variant to be updated through
         * a product that does not own it.
         */
        if (
        ...
        /*
         * Keep variant editing consistent with the
         * product moderation/editing rules.
         *
         * Product::canBeEditedBySeller() currently
         * allows the seller-editable states such as
         * draft, rejected and approved.
         *
         * Approved/rejected catalog changes are returned
         * to draft by the controller for moderation.
         */
        ...
        /*
         * Only active owner/manager seller members
         * may change the product catalog.
         */
    ...
    /**
     * Validation rules for partial product variant updates.
     *
    ...
    /**
     * Normalize only fields explicitly submitted by PATCH/PUT.
     *
     * Unlike the create request, this method must not
     * inject defaults for fields that were omitted.
     */
    ...
    /**
     * Resolve seller profile from route model binding.
     */
    ...
    /**
     * Resolve product from route model binding.
     */
    ...
    /**
     * Resolve variant from route model binding.
     */
